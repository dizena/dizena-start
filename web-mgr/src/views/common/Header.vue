    ...
    <div class="header-right">
      <div class="header-user-con">
        ...
        <div class="btn-fullscreen">
          <a effect="link" content="ICON"  placement="bottom" target="_blank" href="https://element.eleme.cn/#/zh-CN/component/icon">
...
export default {
  ...
  computed: {
    username() {
      ...
      let loginUser = JSON.parse(current_user);
      let username = loginUser.nickname;
